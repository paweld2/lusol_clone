...
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   01 Dec 2005: Reduce default LUSOL_MULT_nz_a values (disable by undef YZHANG)
...
#ifdef YZHANG
/* XXX: 5 is too large for large problems */
#define LUSOL_MULT_nz_a              2  /* Could consider 6 or 7 */
#else
...
#define LUSOL_IP_USERDATA_1          7
#define LUSOL_IP_KEEPLU              8
#define LUSOL_IP_USERDATA_2          9
...
#define LUSOL_IP_USERDATA_3         30
#define LUSOL_IP_LASTITEM            LUSOL_IP_USERDATA_3
...
#define LUSOL_PIVOT_DEFAULT         -1  /* Set pivoting model to default */
#define LUSOL_PIVOT_TPP              0  /* Threshold Partial   pivoting (normal) */
#define LUSOL_PIVOT_TRP              1  /* Threshold Rook      pivoting */
#define LUSOL_PIVOT_TCP              2  /* Threshold Complete  pivoting */
#define LUSOL_PIVOT_TSP              3  /* Threshold Symmetric pivoting */
#define LUSOL_PIVOT_MAX              LUSOL_PIVOT_TSP
...
#define LUSOL_INFORM_MAX             LUSOL_INFORM_NOPIVOT
