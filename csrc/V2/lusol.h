...
#define LUSOL_IP_USERDATA_1          5
#define LUSOL_IP_PIVOTTYPE           6
#define LUSOL_IP_USERDATA_2          7
#define LUSOL_IP_KEEPLU              8
#define LUSOL_IP_USERDATA_3          9
...
#define LUSOL_IP_USERDATA_5         30
#define LUSOL_IP_LASTITEM            LUSOL_IP_USERDATA_5
